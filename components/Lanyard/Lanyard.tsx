        ...
        <div className="container">
          <div className="hero-content">
            ...
            <div className="hero-buttons">
              <a 
                href="https://drive.google.com/uc?export=download&id=1GGaClE5B9XH-P6byoIwC1YwlCeZK8Kse" 
                className="btn btn-primary" 
                target="_blank" 
                rel="noopener noreferrer" 
                download="Fajar_Ramadhandi_Hidayat_CV.pdf" // Menyarankan nama file unduhan
              >
